...
%\usepackage{natbib}
%\usepackage[style=chicago-authordate,sorting=nyt,maxnames=3,doi=true,backend=biber,natbib=true]{biblatex}
\usepackage[authordate,backend=biber]{biblatex-chicago}
\newcommand{\citep}{\parencite}
\newcommand{\citet}{\textcite}
\input{chicago-authordate-aea.tex}
...
\shortTitle{BibLaTeX Data Citations}
...
\lstinputlisting[numbers=left,language=TeX]{chicago-authordate-aea.tex}
...
%
\begin{quote}
	\fullcite{duflopande2006-new}
\end{quote}
%
and
%
\begin{quote}
	\fullcite{leiss1999-new}
\end{quote}
%
\newpage
